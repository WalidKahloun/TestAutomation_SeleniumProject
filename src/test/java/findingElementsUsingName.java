...
public class findingElementsUsingName {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // Open the login page of the test website
        driver.get("https://the-internet.herokuapp.com/login");

        // Locate the username input field using its Name and enter the username "tomsmith"
        driver.findElement(By.name("username")).sendKeys("tomsmith");

        // Locate the password input field using its Name and enter the password "SuperSecretPassword!"
